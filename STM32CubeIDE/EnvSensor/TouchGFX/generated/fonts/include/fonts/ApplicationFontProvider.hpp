...
{
    static const touchgfx::FontId DEFAULT = 0; // segoeui_20_1bpp
    static const touchgfx::FontId LARGE = 1;   // segoeuisl_54_1bpp
    static const touchgfx::FontId HUGE = 2;    // segoeuisl_84_1bpp
