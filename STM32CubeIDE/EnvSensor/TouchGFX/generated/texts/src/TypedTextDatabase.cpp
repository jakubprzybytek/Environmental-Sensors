...
extern touchgfx::GeneratedFont& getFont_segoeuisl_20_1bpp();
extern touchgfx::GeneratedFont& getFont_segoeuisl_40_1bpp();
extern touchgfx::GeneratedFont& getFont_segoeuisl_64_1bpp();

const touchgfx::Font* touchgfx_fonts[] =
{
    &(getFont_segoeuisl_20_1bpp()),
    &(getFont_segoeuisl_40_1bpp()),
    &(getFont_segoeuisl_64_1bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_segoeuisl_20_1bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_segoeuisl_40_1bpp());
        break;
    case 2:
        touchgfx_fonts[2] = &(getFont_segoeuisl_64_1bpp());
        break;
    }
}
}  // namespace TypedTextDatabase
