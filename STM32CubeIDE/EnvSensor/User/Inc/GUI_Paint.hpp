...
#ifndef INC_GUI_PAINT_HPP_
#define INC_GUI_PAINT_HPP_
 ...
 **/
typedef enum {
	MIRROR_NONE = 0x00, MIRROR_HORIZONTAL = 0x01, MIRROR_VERTICAL = 0x02, MIRROR_ORIGIN = 0x03,
} MIRROR_IMAGE;
