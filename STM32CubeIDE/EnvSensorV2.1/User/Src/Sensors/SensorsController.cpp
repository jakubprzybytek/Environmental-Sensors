...
#define BURST_MEASUREMENTS_PERIOD  SENSORS_CONTROLLER_BURST_MEASUREMENTS_PERIOD
#define NORMAL_MEASUREMENTS_PERIOD SENSORS_CONTROLLER_NORMAL_MEASUREMENTS_PERIOD
