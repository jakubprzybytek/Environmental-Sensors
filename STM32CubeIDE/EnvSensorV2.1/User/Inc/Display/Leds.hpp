...
#define DISPLAY_LED_Port LED_2_GPIO_Port
#define DISPLAY_LED_Pin LED_2_Pin
...
#define PARTICLES_SENSOR_LED_Port LED_3_GPIO_Port
#define PARTICLES_SENSOR_LED_Pin LED_3_Pin
#define PARTICLES_SENSOR_LED_On() HAL_GPIO_WritePin(PARTICLES_SENSOR_LED_Port, PARTICLES_SENSOR_LED_Pin, GPIO_PIN_SET)
#define PARTICLES_SENSOR_LED_Off() HAL_GPIO_WritePin(PARTICLES_SENSOR_LED_Port, PARTICLES_SENSOR_LED_Pin, GPIO_PIN_RESET)
